...
Instrucciones para Instalar servidor de Impresiones
1.- Conectas por anydesk
2.- Abre el power shell como administrador
3.- Te diriges a Scripts/PrintServer
4.- Haces: git pull
    Para bajarte todas las actaulizaciones de servidor de impresiones
5.- Ejecutas lo siguiente: powershell -ExecutionPolicy Bypass -File .\install_or_update_service.ps1
    Para actaulizar el servicio de impresión
    Si sale error se ejecuta:
    python .\print_server_service.py stop
    python .\print_server_service.py remove
6.- Marcas como actualizado en el excel de restaurantes que te nemos en el drive
